...
pathlib.Path("core/messaging/message_bus.py").write_text(content, encoding="utf-8")
print("✅ message_bus.py escrito!")

checks = ["Consumer thread iniciada", "run_coroutine_threadsafe", "on_assign", "_consume_loop_sync"]
for c in checks:
